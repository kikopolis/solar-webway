...
<template>
    <div class="sm:fixed sm:top-0 sm:end-0 p-6 text-end z-10 bg-gray-100 dark:bg-gray-800 w-full">
        <Link :href="route('book')" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 mx-4">Booking</Link>
